        ...
        <article
          ...
          {usuario.rol === 'usuario' ? (
            <section className='contenidoSecundario'>
              <div className='botonEnviarLicencias'>
                <Fab
                  ...
                  color='primary'
                  aria-label='add'>
                  <NavigationIcon sx={{ mr: 1 }} icon={<PostAddIcon />} /> Crear
                  nueva solicitud
                </Fab>
              </div>
            ...
            <section className='contenidoSecundario'>
              <box>
                <span>
                  Hola, yo me renderizo cuando soy admin jeje, cambiame desde el
                  contexto para ver la data que le aparece al usuario
                </span>
              </box>
            </section>
          )}
